...
This project comes as the solution to the lack of a text-based document solution. LaTeX is not my favorite flavor, and HTML rocks since it can be printed or used on the web and the internet. Writing HTML sucks. Textile eases that out.
